---
title: "Documentation Space - Open Discourse v. `r current_version_tag`"
...
If you want to cite the Open Discourse corpus, please cite the resource by referring to the respective data version at the Harvard Dataverse:
